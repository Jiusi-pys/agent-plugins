...
本包基于 OpenAI 的 `epub-editor` 能力，为 Claude Code marketplace 提供 EPUB 编排技能、处理脚本及测试。

## 安装与使用

在 Claude Code 中从本仓库的 `jiusi-agent-plugins` marketplace 安装 `epub-editor`，提供 EPUB 路径和修改要求，例如：“修改这本书的作者并统计字数，保留其他元数据。”
