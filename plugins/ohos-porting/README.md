...
- **6 个 Skill**: porting-diagnostics, api-mapping, compile-error-analysis, runtime-debug, working-records, ohos-remote-build
- **自动错误诊断**: 编译失败时自动触发诊断
...
- `ohos-hdc` → 集成到 runtime-debugger 和 deploy 命令
